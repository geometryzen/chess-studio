...
export function perft(pos: Position, depth: number, print_moves: boolean): number {
...
function perft_print_move(pos: Position, mv: string, val: unknown): void {
...
let perft_known_values: Record<string, number[]> = {
