...
import { assert_point, point_from_xy, Position } from "./Position";
...
const PolyglotPieceXorVals = [
    // the trailing n here means BigInt
    0x9d39247e33776d41n,
    0x2af7398005aaa5c7n,
    0x44db015024623547n,
    0x9c15f73e62a76ae2n,
...
const PolyglotCastleXorVals = [0x31d71dce64b2c310n, 0xf165b587df898190n, 0xa57e6339dd2cf3a0n, 0x1ef6e6dbb1961ec9n];

const PolyglotEnPassantXorVals = [0x70cc73d90bc26e24n, 0xe21a6b35df0c3ad7n, 0x003a93d8b2806962n, 0x1c99ded33cb890a1n, 0xcf3145de0add4289n, 0xd0e4427a5514fb72n, 0x77c621cc9fb3a483n, 0x67a34dac4356550bn];

const PolyglotActiveXorVal = 0xf8d626aaaf278509n;

// ------------------------------------------------------------------------------------------------------------------------

const PolyglotMoveLookup: string[] = []; // Lookup table for book blob bytes 8-9. Most of the moves are impossible, but meh.
...
for (let n = 0; n < 65536; n++) {
    ...
    let source = assert_point(point_from_xy(from_file, 7 - from_row));
    let dest = assert_point(point_from_xy(to_file, 7 - to_row));
...
export function KeyFromBoard(board: Position): bigint | "" {
    if (!board) return "";
...
*/
/*
function BookAtLogicalIndex(book: Buffer | { key: bigint; move: string; weight: number }[], i: number): { key: bigint; move: string; weight: number } {
    if (book instanceof Buffer) {
...
*/
/*
function BookLogicalLength(book: Buffer) {
    if (book instanceof Buffer) {
...
*/
/*
function BookProbe(key, book: Buffer) {
...
function BigIntToHex(big: bigint): string {
