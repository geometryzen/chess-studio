...
export const renderPiece: RenderPieceFunction = (piece: Piece, container: HTMLElement) => {
    render(html` <svg class="piece-image" viewBox="0 0 45 45">${pieces[piece]}</svg> `, container);
};

// Pieces taked from: https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces
