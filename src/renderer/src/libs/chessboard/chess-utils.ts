...
export const validPositionObject = (pos: unknown): pos is PositionObject => {
...
export const START_POSITION = fenToObj(START_FEN) as PositionObject;

// position object to FEN string
// returns false if the obj is not a valid position object
export const objToFen = (obj: PositionObject) => {
...
export const findClosestPiece = (position: PositionObject, piece: string, square: string) => {
