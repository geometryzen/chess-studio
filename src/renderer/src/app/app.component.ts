...
export class AppComponent implements OnInit, OnDestroy {
    ...
    @ViewChild(ChessBoard) boardUX!: ChessBoard;
    /**
    ...
    async ngOnInit() {
        ...
        this.boardUI = document.getElementById("board-ui") as ChessBoardElement;
        this.change$ = fromEvent<ChangeEvent>(this.boardUI, "change");
        this.boardUI.sparePieces = false;
        this.boardUI.draggablePieces = true;
        this.boardUX.sparePieces = false;
        this.boardUX.draggablePieces = true;
        ...
        fromEvent<SnapbackEndEvent>(this.boardUI, "snap-end").subscribe((event) => {
            ...
            // console.lg("Orientation: " + orientation);
            if (this.is_setup_mode) {
                const position = this.boardUI.fen();
                if (position) {
                ...
                this.boardUI.setPosition(this.position);
                this.boardUX.setPosition(this.position);
            }
        });
        ...
        this.controller.onNewGameClassic(() => {
            this.tree.reset();
            this.position = this.tree.fen();
            this.boardUI.setPosition(this.position, this.useAnimation);
            this.boardUX.setPosition(this.position, this.useAnimation);
            this.exitSetupMode();
        });
        this.controller.onGameClear(() => {
            ...
            this.boardUX.clear(this.useAnimation);
            this.enterSetupMode();
        });
    ...
    enterSetupMode() {
        ...
        this.boardUX.sparePieces = true;
        this.boardUX.dropOffBoard = "trash";
        this.updateStatus();
    }
    exitSetupMode() {
        this.boardUI.sparePieces = false;
        ...
        this.boardUX.sparePieces = false;
        this.boardUX.dropOffBoard = "snapback";
